...
impl fmt::Display for Metainfo {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> Result<(), fmt::Error> {
        ...
        writeln!(fmt,  "announce:\t{:?}", self.announce.clone().unwrap_or_default())?;
        ...
        writeln!(fmt,  "creation date:\t{:?}", self.creation_date.unwrap_or_default())?;
        writeln!(fmt,  "comment:\t{:?}", self.comment.clone().unwrap_or_default())?;
        writeln!(fmt,  "created by:\t{:?}", self.created_by.clone().unwrap_or_default())?;
        writeln!(fmt,  "encoding:\t{:?}", self.encoding.clone().unwrap_or_default())?;
